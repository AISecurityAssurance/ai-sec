-- Migration: 019_step2_force_rebuild.sql
-- Description: Force rebuild of Step 2 tables
-- Created: 2025-01-30
...
DROP TABLE IF EXISTS operational_modes CASCADE;
DROP TABLE IF EXISTS step2_agent_results CASCADE;

-- Keep step2_analyses but ensure it has all columns
